...
<html>
    <head>
        <title>Register - NIT RAIPUR</title>
               ...
               ?>
                <br>
                 ...
                 <form action="" method="POST" class="text-center">
                  ...
                  <div class="inputBox">
                  <input type="password" name="password" autocomplete="off" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{4,15}"
  title="Must contain at least one  number and one uppercase and lowercase letter, and at least 4 and max 15 characters" required>
				            <label>Password</label>
			            </div>
                  <div class="inputBox">
                    <input type="text" name="csed_id" autocomplete="off" pattern="(?=.*\d)(?=.*[A-Z]).{11}" title="Must contain number and uppercase  letter of exact length 11 " required="">
				            <label>Roll No</label>
			            </div>
            ...
            <p class="text-center" style="color:#fff">Created By - <a href="https://www.linkedin.com/in/himanshu-chaurasiya-80973a216/">Himanshu</a></p>
        </div>
      </div> 
    </body>
</html>
...
<?php 
  ...
  if(isset($_POST['Register']))
  {
      ...
      if(strcmp($main_str,"nitr.ac.in")!=0)
      {
        ?>
        <script>Swal.fire({
          icon: 'error',
          title: 'Oops...',
          text: 'Use NITR mail only',
      ...
      {
       $sql1="SELECT * FROM user WHERE e_mail='$e_mail'";
