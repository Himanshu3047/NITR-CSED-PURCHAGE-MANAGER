               ...
               ?>
                <br>
                 ...
                 <div class="inputBox">
                  ...
                  <br><br>
                  <a href="<?php echo SITEURL; ?>admin_hod/" class="btn btn-primary" role="button" style="margin-right:22%;">Admin Login</a>
                     <br><br>
                 </form>
            <p class="text-center" style="color:#fff;">Created By - <a href="https://www.linkedin.com/in/himanshu-chaurasiya-80973a216/">Himanshu</p>
        </div>
     </div> 
    </body>
</html>
...
<?php 
  if(isset($_POST['submit']))
  {
      ...
      $sql="SELECT * FROM user WHERE e_mail='$e_mail' AND password='$password'";
      //3.Execute Query
